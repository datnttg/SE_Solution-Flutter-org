...
import 'package:se_solution/screens/task/controllers/task_ui_controllers.dart';
  ...
  Widget build(BuildContext context) {
    ...
    bool addSubject() {
      ...
      if (subject.name == '' || subject.phone == '') {
        kShowAlert(
            body: KText(
                sharedPrefs.translate('Please input required field(s)!')),
