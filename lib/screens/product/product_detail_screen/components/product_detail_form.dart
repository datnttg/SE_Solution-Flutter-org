              ...
              children: [
                      ...
                      builder: (context, snapshot) {
                        ...
                        if (snapshot.hasData) {
                          return CDropdownMenu(
                            ...
                            required:
                                bloc.screenMode.state == ScreenModeEnum.edit,
                            readOnly: readOnly,
                ...
                ResponsiveItem(
                  child: CSwitch(
                    ...
                    onChanged: (value) {
                      bloc.eventController
                          .add(ChangeProductRequiredSerial(value));
                    },
                  ),
                ),
                ...
                ResponsiveItem(
                  child: CTextFormField(
                    ...
                    onChanged: (value) {
                      bloc.eventController
                          .add(ChangeProductMonthsOfWarranty(value));
                    },
                  ),
                ),
                        ...
                        if (snapshot.hasData) {
                          return CDropdownMenu(
                            ...
                            selectedMenuEntries: snapshot.data!.listCategory!
                                ...
                                .toList(),
                            onSelected: (value) {
                              bloc.eventController.add(
                                  ChangeProductCategory(value.first.value));
                            },
                          );
                        }
                        return COnLoadingDropdownMenu(
